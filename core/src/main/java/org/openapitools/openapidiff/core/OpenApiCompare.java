...
public class OpenApiCompare {
    ...
    public static ChangedOpenApi fromContents(String oldContent, String newContent, Configuration aConfiguration) {
    ...
    public static ChangedOpenApi fromContents(
            String oldContent, String newContent, List<AuthorizationValue> auths, Configuration aConfiguration) {
        return fromSpecifications(readContent(oldContent, auths), readContent(newContent, auths), aConfiguration);
    }
    ...
    public static ChangedOpenApi fromFiles(
        ...
        return fromLocations(oldFile.getAbsolutePath(), newFile.getAbsolutePath(), auths, aConfiguration);
    }
    ...
    public static ChangedOpenApi fromLocations(String oldLocation, String newLocation, Configuration aConfiguration) {
    ...
    public static ChangedOpenApi fromLocations(
            String oldLocation, String newLocation, List<AuthorizationValue> auths, Configuration aConfiguration) {
        return fromSpecifications(readLocation(oldLocation, auths), readLocation(newLocation, auths), aConfiguration);
    }
    ...
    public static ChangedOpenApi fromSpecifications(OpenAPI oldSpec, OpenAPI newSpec) {
        return OpenApiDiff.compare(notNull(oldSpec, "old"), notNull(newSpec, "new"), new Configuration());
    }

    public static ChangedOpenApi fromSpecifications(OpenAPI oldSpec, OpenAPI newSpec, Configuration aConfiguration) {
