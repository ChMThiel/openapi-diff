...
public class MarkdownRender implements Render {
    ...
    /**
     * A parameter which indicates whether or not metadata (summary and metadata) changes should be logged in the
     * changelog file.
     */
    ...
    public String render(ChangedOpenApi diff) {
        ...
        List<ChangedOperation> changedOperations = diff.getChangedOperations().stream()
                .filter(o -> {
